...
angular.module('voyager.security').
    factory('authService', function ($http, config, $q, $log) {
        ...
        var _PERMISSIONS = ['manage','download','process','configure_view','save_search','share_saved_search','view','tag','edit_fields','flag','view_tags','show_metadata','export','shutdown_restart'];
